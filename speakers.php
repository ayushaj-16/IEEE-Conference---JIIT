...
<div class="container" style="position: relative;  z-index: -1;">
    <div class="about">
        ...
        <h2 class="name">KEYNOTE SPEAKERS</h2>
        <hr>
...
<div class="col-sm-3">
                <img src="img/Prof. Banmali Rawat.jpg" alt="" height="200px" width="150px">
                <br>
                <br>
              
</div>
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Banmali S. Rawat</h4><p>University of Nevada, Reno, USA
    </p></button>
<div class="content">
<br>
<p>Banmali S. Rawat was born in Garhwal, Uttarakhand, India. He received BSEE, MSEE degrees from the Indian Institute of Technology, (Banaras Hindu University), Varanasi and Ph.D. (ECE) from Sri Venkateswara University, Tirupati, India in 1968, 1970 and 1976, respectively.
...
<div class="col-sm-3">
                <img src="img/ss.png" alt="" height="200px" width="150px">
                <br>
                <br>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Satish Kumar Sharma</h4><p> San Diego State University, USA</p>
    </button>
<div class="content">
<br>
<p>Dr. Satish Kumar Sharma is a Professor and Director of Antenna and Microwave Lab (AML) at San Diego State University
(SDSU). He has received the National Science Foundation (NSF)’s prestigious faculty early career development (CAREER)
award in 2009 and DURIP 2016 funded by Office of Naval Research (ONR). He also received 2015 IEEE AP-S Harold A.
Wheeler Prize Paper Award of the IEEE Antennas and Propagation Society for his coauthored paper on anti-jamming
antennas. He served as an Associate Editor of the IEEE Transactions on Antennas & Propagation journal since August
2010. Currently, he is serving as an Associate Editor of the IEEE Antennas, Wireless & Propagation Letters. His research
lab has capability to analyze, design, develop, and verify antennas from VHF to millimeter wave (110 GHz) frequencies.
</p>
<p>He has published over 260 journal and conference papers and holds one US and one Canadian Patent on Multiple Phase
Center Feedhorn. He has also co-edited three volumes of “Handbook of Reflector Antennas and Feed Systems”, published
by Artech House in May/June 2013. His another coauthored book, “Multifunctional Antennas and Arrays for Wireless
Communication Systems”, has been published by IEEE-Press/Wiley in April 2021. He has collaborated with industry on
SBIR/STTR Phase I and II projects funded by DARPA, SPAWAR, Missile Defense Agency, Air Force Research Lab (AFRL)
in addition to the projects from the NSF, Office of Naval Research (ONR). He also has served as Engineer/Consultant with
industry such as Kyocera, Space Systems Loral (SS/L), Cubic Defense Applications, TaoGlas, DIRECTV, AT&T and several
other local industries on different antenna projects. He is also CEO/founder of 5GAntennaTech, LLC. His research interests
include microwave and millimeter-wave frequencies beam steering antennas, reconfigurable and tunable antennas, 3D
printed antennas, inkjet printed conformal array antennas, massive MIMO antennas, antennas for Cube-Satellites, reflector
antennas and its feed systems and metasurface antennas.
</p>
</div>
<div class="col-sm-12" style="margin-bottom: 3rem"><br>
    <button class="collapsible" style="background-color: #92c3ff; text-align:center"><h4 style="font-size: 20px;">Keynote Talk On:</h4><h4><span style="font-size: 19px;"><h5 style="display:inline;font-size: 16px;font-weight: 600;">"Innovative Phased Array Antennas for Enhanced Wireless and Satellite Communication Applications"</h5></span></h4></button>
<div class="content">
<br>
<p><strong>ABSTRACT: </strong>There is a great demand for the high data throughput innovative phased array antenna solutions for wireless and satellite communication applications. Theory and design of the phased array antennas, beamforming network and beamforming algorithm requirements along with multiple examples of the phased array antennas designed and developed in the Antenna and Microwave Laboratory (AML) at San Diego State University will be discussed. The laboratory includes a far-field anechoic chamber (800 MHz to 40 GHz) and a millimeter wave mini-compact antenna test range (26.5 GHz to 110 GHz) in addition to other research resources. Challenges and roles of the emerging technologies such as silicon RFICs in modern phased array antenna designs will be discussed.</p>
</div>
</div>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;"> Mr. Deepak Mathur </h4><p>Director of IEEE Region 10 (Asia-Pacific Region)</p>
    </button>
<div class="content">
<br>
...
<div class="col-sm-12" style="margin-bottom: 3rem"><br>
    <button class="collapsible" style="background-color: #92c3ff; text-align:center"><h4 style="font-size: 20px;">Keynote Talk On:</h4><h4><span style="font-size: 19px;"><h5 style="display:inline;font-size: 16px;font-weight: 600;">"IEEE - world's largest technical professional organization for the advancement of technology."</h5></span></h4></button>
<div class="content">
<br>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Parthasarathi Chakrabarti</h4><p>Indian Institute of Engineering Science & Technology, Shibpur</p>
    </button>
<div class="content">
<br>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Ram Bilas Pachori</h4><p>Indian Institute of Technology, Indore</p>
    </button>
<div class="content">
<br>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Rajiv Saxena</h4><p>Jaypee University, Anoopshahr</p>
    </button>
<div class="content">
<br>
...
<div class="col-sm-12" style="margin-bottom: 3rem"><br>
    <button class="collapsible" style="background-color: #92c3ff; text-align:center"><h4 style="font-size: 20px;">Keynote Talk On:</h4><h4><span style="font-size: 19px;"><h5 style="display:inline;font-size: 16px;font-weight: 600;">To Be Updated Soon</h5></span></h4></button>
<div class="content">
<br>
</div>
</div>
...
<div class="col-sm-9">
    <button class="collapsible"><h4 style="font-size: 22px;">Prof. Satish Kumar Singh</h4><p>Indian Institute of Information Technology, Allahabad
    </button>
<div class="content">
<br>
