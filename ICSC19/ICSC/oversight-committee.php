...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; From IEEE UP Section</title>
    ...
    <div class="b_page clearfix">
        <div id="content">
            ...
            <div class="post-306 page type-page status-publish hentry post">
                            ...
                            <div class="b w_940">
                                <h2 class="entry-title">From IEEE UP Section</h2>
                            </div>
                            ...
                            <div class="b w_620">
                                ...
                                <ul class="xoxo">
                                    <li class="widget">
                                        <div class="b_text">
                                            <p>1) <strong>Dr. Ekram Khan</strong><br />
IEEE UP Section,Convener, Professional activities committee</p>
<p>2) <strong>Dr. Satish K Singh</strong><br />
IEEE UP Section, Treasurer</p>
<p>3) <strong>Dr. S.N. Singh</strong><br />
IEEE UP Section,Convener, Award and recognition committee </p>
<p>4) <strong>Dr. Kunwar Singh Vaisla </strong><br />
IEEE UP Section, Member, ExCom</p>
