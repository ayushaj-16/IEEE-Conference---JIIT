...
-->
    ...
    <body  class="page page-id-395 page-template-default logged-in larger" style="background-color:rgb(153,153,204) ; background-image: url(lib/images/pattern/pattern.flowers.png);" onload="initialize()">
