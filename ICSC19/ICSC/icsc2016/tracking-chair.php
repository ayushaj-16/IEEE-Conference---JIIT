...
<meta name="author" content="Shivan Trivedi and Mayank Nayyar"/> 
                                ...
                                <ul class="xoxo">
                                    <li class="widget">
                                        <div class="b_text">
											...
											<div class="wp-caption alignleft circle"><a href="tracking-chair.php?i=1"><img src="2015/03/Screenshot-19-150x135.png" alt="Prof. Banmali Rawat"></a></div>
											<h4><a class="readmore" href="tracking-chair.php?i=1">Prof. Banmali Rawat<span class="mosaic-overlay">&nbsp;</span></a></h4>
											<p><span class="exc" style="text-align: justify;">Banmali S. Rawat was born in Garhwal, Uttarakhand, India. He received BSEE, MSEE degrees from the Indian Institute of Technology, (Banaras Hindu University), Varanasi and Ph.D. (ECE) from Sri Venkateswara University, Tirupati, India in 1968, 1970 and 1976, respectively. He was recipient of National Merit ...</span>
											<p class="button readmore hover margin15"><a href="tracking-chair.php?i=1">Continue reading<span>&nbsp;</span></a></p></div></div><br />
											<div class="okrdx-accordion"> <h2 class="okrdx-acc-trigger"><a href="#">Signal Processing</a></h2><div class="okrdx-acc-container">.
											<div class="wp-caption alignleft circle"><a href="tracking-chair.php?i=2"><img src="2015/03/sdjoshi.jpg" alt="Prof. S.D. Joshi"></a></div>
											<h4><a class="readmore" href="tracking-chair.php?i=2">Prof. S. D. Joshi <span class="mosaic-overlay">&nbsp;</span></a></h4>
											<p><span class="exc" style="text-align: justify;">S.D.Joshi received the B.E.(Hons.) degree in electrical and electronics engineering from Birla Institute of Technology, Pilani, India, in 1981 and M.Tech degree in communications and radar engineering and Ph.D. degree, both from Indian Institute of Technology, Delhi, in 1983 and 1988 respectively. &#8230;</span>
											<p class="button readmore hover margin15"><a href="tracking-chair.php?i=2">Continue reading<span>&nbsp;</span></a></p></div></div><br />
											<div class="okrdx-accordion"> <h2 class="okrdx-acc-trigger"><a href="#">VLSI</a></h2><div class="okrdx-acc-container">.
											<div class="wp-caption alignleft circle"><a href="tracking-chair.php?i=3"><img src="2015/03/san.jpg" alt="Dr.sanjeev manhas"></a></div>
											<h4><a class="readmore" href="tracking-chair.php?i=3">Dr. Sanjeev Manhas<span class="mosaic-overlay">&nbsp;</span></a></h4>
											<p><span class="exc" style="text-align: justify;">Assistant Professor<br />Semiconductor Devices and VLSI Technology (SDVT)<br />
											Dept of Electronics & Computer Engineering,IIT Roorkee, Uttarakhand, India 247667<br />
											<br /></span>
											<p class="button readmore hover margin15"><a href="tracking-chair.php?i=3">Continue reading<span>&nbsp;</span></a></p></div></div></p>
                                                                                    </div>
                                    </li>
                                </ul>
                            </div>
...
Dr. Rawat is a Fellow of IETE, Fellow of CIE, Fellow of the Electromagnetics Academy established at MIT, Fellow of JSPS, Fellow of Optical Society of India, Life Senior Member of IEEE, Member of Sigma Xi, North Dakota Academy of Sciences, Optical Society of America, SPIE, and Eta Kappa Nu - the EE Honor Society.  He has been a Soccer Coach/Division Coordinator/Governing Board Member with AYSO, Sparks, NV, Program Volunteer/Governing Board Member of the Junior Ski Program of Reno, NV and Founder/President of the India Association of Northern Nevada (IANN).</p>
						...
						?>
							<div class="b w_940">
                                <h2 class="entry-title">Prof. S.D. Joshi</h2>
							</div>
							<div class="b w_620">
								<ul class="xoxo">
									<li class="widget">
										<div class="b_text">
											<p><img class="size-full wp-image-233 alignleft" alt="" src="2015/03/sdjoshi.jpg"></p>
							<p style="text-align: justify;">S.D.Joshi received the B.E.(Hons.) degree in electrical and electronics engineering from Birla Institute of Technology, Pilani, India, in 1981 and M.Tech degree in communications and radar engineering and Ph.D. degree, both from Indian Institute of Technology, Delhi, in 1983 and 1988 respectively. He worked as a Lecturer at the Delhi Institute of Technology, Delhi, from 1988 to 1989 and joined Indian Institute of Technology, Delhi, as a faculty member in May, 1989, where he is currently a Professor in Electrical Engineering Department. His research interests include development of fast algorithms for stochastic signal processing, speech processing, group theoretical approach to signal processing and image processing. Prof. Joshi is a recipient of the AES award from the IEEE Aerospace and Electronic Systems/IEEE Communication Society (AES/COM), Indian Chapter, for the year 1986</p>
							<p style="text-align: justify;">Teaching Excellence Award to Prof. S.D.Joshi, Department of Electrical Engineering for 2nd Semester 2010-11 for the Course Signals and Systems (EEL205)</p>
																				</div>
									</li>
								</ul>
							</div>
						...
						?>
							<div class="b w_940">
                                <h2 class="entry-title">Prof. Sanjeev Manhas</h2>
							</div>
							<div class="b w_620">
								<ul class="xoxo">
								<li class="widget">
								<div class="b_text">
								<p><img style="align: left;" alt="" src="2015/03/san.jpg"><br>
								Assistant Professor
                                Semiconductor Devices and VLSI Technology (SDVT)</p>
								<p>Dept of Electronics & Computer Engineering
                                 IIT Roorkee, Uttarakhand, India 24766</p>
								<ol>
								<p><strong>Research and Awards</strong></p>
								
								<li>Design and analysis of Si Nano
                                  applications, Indian Institute of Technology, Roorkee, Dec 08</li>
								<li>wire circuit design, parasitic evaluation and fabrication technologies
                                  MOSFET modeling and reliability
                                  age mechanisms and refresh
                                  organic thin film transistors</li>
								<li> Reviewer IEEE electron device letters 2000</li>
								<li>Member IEEE since January 2000</li>
								<li>Indian National Research Scholarship (CSIR, 1993)</li>
								<li>State (Himachal Pradesh, India) graduate merit award (1991)</li>
								
								</ol>
								
								</ul>
								<p><strong>Interest Area(s)</strong></p>
								<p>DRAM leakage mechanisms and refresh</p>
								</div>
								</li>
								</ul>
							</div>
